<template>
  <div class="container">
    ...
    <div class="filterButtons">
      ...
      <button :class="{ active: slideFilter === 'items' }" @click="slideFilter = 'items'">
        Only Items
      </button>
      <button :class="{ active: slideFilter === 'repairs' }" @click="slideFilter = 'repairs'">
        Only Repair Shops
      </button>
    </div>
    <div class="main">
...
const categories = ref([
  {
    ...
    slug: 'furniture-home',
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaVNmjsv3kTlDf_0RS0xRjuR4QSqJfrppOUQ&s',
  },
  {
    id: 2,
    name: 'Electronics',
...
const prevSlide = () =>
  (currentIndex.value =
    (currentIndex.value - 1 + filteredSlides.value.length) % filteredSlides.value.length)
const nextSlide = () =>
