    ...
    <div class="page-container">
      ...
      <div v-else style="">
                ...
                <div style="display:flex; justify-content: center;">
                    <div class="carousel-container" >
                            ...
                            <div class="carousel-track" ref="carouselTrack">
                                ...
                                <div class="carousel-slide" v-for="post in posts" :key="post.id">
                                    <div class="carousel-image-wrapper">
                                        <img :src="user.profile_image" alt="Post Image" class="carousel-image" />
                                    </div>
                                    <div >
                        ...
                        <div class="carousel-controls">
                            <button @click="scrollCarousel(-1)">Prev</button>
                            <button @click="scrollCarousel(1)">Next</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid-reviews">
          ...
          <div><button class="button" style="width: 100%; margin-top: 20px;">All Ratings</button></div>
        </div>
      </div>
    </div>
  </template>
